...
in {
  ...
  # Add the colors file
  # Commented out because i can just add a theme in firefox settings
  ...
  #         --uc-identity-colour-pink:    ${config.lib.stylix.colors.base0E};
  #         --uc-iE};
  ...
  #         --uc-inverted-colour: ${config.lib.stylix.colors.base07};
  #         --uc-muted-colour:    ${config.lib.stylix.colors.base04};
