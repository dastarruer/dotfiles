...
{inputs, ...}: {
  ...
  in {
    ...
    home-manager.users.dastarruer = {
      ...
      home.file."${hitmanPath}/Retail/mods/missioncompanion.ini" = let
        iniFormat = pkgs.formats.ini {};

        # Since we configured the name of the smf non steam app above, the generated prefix id should always stay the same. Not sure if this is entirely true, but oh well...
        ...
        # Also do note the \ instead of / for paths. windows is weird sometimes
