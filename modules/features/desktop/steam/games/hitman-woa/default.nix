...
{inputs, ...}: {
  flake.nixosModules.desktop_steam = {
    ...
    smfZip = pkgs.fetchzip {
      ...
      hash = "sha256-Kv78ZQQ2itsZQorizswV5f7eVATe08ZNnmtKmYheuiY=";
      stripRoot = false;
    };
    zhmmodsdkZip = pkgs.fetchzip {
      url = "https://github.com/OrfeasZ/ZHMModSDK/releases/download/v4.1.1/ZHMModSDK-Release.zip";
      hash = "sha256-Kv78ZQQ2itsZQorizswV5f7eVATe08ZNnmtKmYheuiY=";
      stripRoot = false;
    };
    ...
    lastDeployJsonPath = ''Z:\home\dastarruer\.local\share\Steam\steamapps\compatdata\${smfPrefix}\pfx\drive_c\users\steamuser\AppData\Local\Simple Mod Framework\lastDeploy.json'';
    # /home/dastarruer/.local/share/Steam/steamapps/compatdata/3086416570/pfx/drive_c/users/steamuser/AppData/Local/Simple Mod Framework/lastDeploy.json
