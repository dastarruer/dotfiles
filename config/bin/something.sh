#!/usr/bin/env bash
# https://github.com/erenseymen/smart-pause-resume/blob/master/smart-pause-resume
###############################################################################
...
on_event() {                  # on_event <busName> <status>
  ...
  case $status in
    ...
    Paused|Stopped)
      ...
      #  Commented out resume_next because i dont want spotify to start blasting music all of a sudden
